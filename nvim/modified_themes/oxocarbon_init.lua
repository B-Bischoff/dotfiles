...
vim.api.nvim_set_hl(0, "@lsp.type.namespace", {link = "@keyword"})
...
vim.api.nvim_set_hl(0, "Boolean", {fg = oxocarbon.base15, bg = oxocarbon.none})
...
vim.api.nvim_set_hl(0, "Define", {fg = oxocarbon.base15, bg = oxocarbon.none})
...
vim.api.nvim_set_hl(0, "Function", {fg = oxocarbon.base10, bg = oxocarbon.none})
...
vim.api.nvim_set_hl(0, "Label", {fg = oxocarbon.base14, bg = oxocarbon.none})
...
vim.api.nvim_set_hl(0, "StorageClass", {fg = oxocarbon.base14, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "String", {fg = oxocarbon.base08, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "Structure", {fg = oxocarbon.base14, bg = oxocarbon.none})
...
vim.api.nvim_set_hl(0, "Type", {fg = oxocarbon.base14, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "Typedef", {fg = oxocarbon.base14, bg = oxocarbon.none})
